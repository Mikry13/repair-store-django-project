...
class Repairs(DefaultModel):
    repairing_item = models.ForeignKey('stock_items.StockItem', related_name='repairs', on_delete=models.CASCADE)  # TODO: add delete signal
    ...
    amount = models.PositiveIntegerField('Количество использованных запчастей')
...
class Warranty(DefaultModel):
    ...
    initial_months_length = models.PositiveIntegerField('Изначальный размер гарантии', null=True, blank=True)
