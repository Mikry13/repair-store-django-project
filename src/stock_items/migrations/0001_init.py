    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Новое', 'New'), ('Поставка', 'Shipping'), ('На складе', 'In Stock'), ('Ремонтируется', 'Repairing'), ('На продаже', 'In Store'), ('Архив', 'Archive'), ('Проблемы после продажи', 'Post Selling Issues')], default='Новое', max_length=64, verbose_name='Статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_months_length', models.PositiveIntegerField(blank=True, null=True, verbose_name='Изначальный размер гарантии')),
                ('store_warranty', models.BooleanField(verbose_name='Гарантия магазина')),
                ('description', models.TextField(verbose_name='Описание')),
                ('stock_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stock_items.stockitem', verbose_name='Вещь на складе')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveIntegerField(verbose_name='Количество использованных запчастей')),
